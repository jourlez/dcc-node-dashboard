...
Contributors: jourlez

Tags: Decentralchain, dcc-node-dashboard
...
[![Coding Standards](https://github.com/decentralchain/dcc-node-dashboard/actions/workflows/coding-standards.yml/badge.svg)](https://github.com/decentralchain/dcc-node-dashboard/actions/workflows/coding-standards.yml)
[![Testing Suite](https://github.com/decentralchain/dcc-node-dashboard/actions/workflows/unit-test.yml/badge.svg)](https://github.com/decentralchain/dcc-node-dashboard/actions/workflows/unit-test.yml)

Node Dashboard for Decentralchain.
...
```bash
composer require decentralchain/dcc-node-dashboard
```
...
```php
$plugin = DCC_Node_Dashboard\DCC_Node_Dashboard\DCC_Node_Dashboard();
...
The command will prompt the user through several options for creating an entry or slotfill. The entries are scaffolded with the `@decentralchain/create-entry` script. Run the help command to see all the options:

```sh
npx @decentralchain/create-entry --help
```
[Visit the package README](https://www.npmjs.com/package/@decentralchain/create-entry) for more information.
...
Use the `create-block` command to create custom blocks with [@decentralchain/create-block](https://github.com/decentralchain/alley-scripts/tree/main/packages/create-block) script and follow the prompts to generate all the block assets in the `blocks/` directory.
...
Interactive](https://github.com/decentralchain). Like what you see? [Come work
with us](https://alley.co/careers/).

- [Josué Rojas](https://github.com/Josué Rojas)
